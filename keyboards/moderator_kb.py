...
def moderator_topics_list_kb(topics: list):
...
def moderator_group_list_kb(topic_id: int):
...
def moderator_available_groups_kb(topic_id: int):
...
def moderator_users_list_kb(topic_id: int):
...
def moderator_users_to_add_kb(topic_id: int):
